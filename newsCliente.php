...
<script>
  ...
  function my_callback_function(response) {
	...
	//alert(msg.filename);	
	//modificado
	recargaImgC(msg.filename, 'cliente');
	//
  }	
  ...
  <form id="form" class="ideal-form" action="javascript:saveForm('form','cliente/save.php')" >
      ...
      <legend>N U E V O&nbsp;&nbsp;&nbsp;C L I E N T E</legend>
      	...
      	<div id="fotoC">
        	<img class="thumb" src="thumb/phpThumb.php?src=../modulo/cliente/uploads/photos/sin_imagen.jpg&amp;w=100&amp;h=100&amp;far=1&amp;bg=FFFFFF&amp;hash=361c2f150d825e79283a1dcc44502a76" alt="">        	
        </div>      	
        ...
        <div id="borderForm">        
            ...
            <div class="idealWrap">
            <textarea id="obserC" name="obserC" cols="2" placeholder="Observaciones" class="validate[custom[onlyLetterSp]]"></textarea>
            </div><!--End idealWrap-->
            <div class="clearfix"></div>

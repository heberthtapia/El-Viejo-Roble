...
/* GOOGLE MAPS */
  ...
  <form id="form" class="ideal-form" action="javascript:saveForm('form','cliente/save.php')" >
  	<fieldset>
      <legend>N U E V O&nbsp;&nbsp;&nbsp;C L I E N T E</legend>
        ...
        <input id="codCl" name="codCl" type="text" placeholder="Cod. Cliente" value="<?=$_SESSION['inc'].''.$op->ceros($NumRow[0],2);?>" class="validate[required] text-input" autocomplete="off" readonly/>
        <input id="codCli" name="codCli" type="hidden" value="<?=$_SESSION['inc'].''.$op->ceros($NumRow[0],2);?>"/>
        </div><!--End idealWrap-->    
        
        <div class="idealWrap WrapD">
        <input id="nameEmp" name="nameEmp" type="text" placeholder="Nombre Negocio" value="" class="validate[required] text-input" autocomplete="off"  />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap Wrap">
        <input id="name" name="name" type="text" placeholder="Nombre" value="" class="validate[required] text-input" autocomplete="off" onBlur="cargaCod()"/>
        </div><!--End idealWrap-->        
        
        <div class="idealWrap Wrap">
        <input id="paterno" name="paterno" type="text" placeholder="Ap. Paterno" value="" class="validate[required] text-input" onBlur="cargaCod()" />
        </div><!--End idealWrap-->
        ...
        <input id="ci" name="ci" type="text" placeholder="N° C.I." value="" class="validate[custom[integer1]] text-input" />
        ...
        <select data-placeholder="Departamento" id="dep" name="dep" title="Seleccione" class="chosen-select">

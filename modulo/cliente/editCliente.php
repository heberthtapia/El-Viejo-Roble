...
<style>
	...
	#camera{
		margin: -490px auto auto 106px;
		}
	input#codCl[type="text"] {
    	cursor: not-allowed;
		}
</style>
...
/* GOOGLE MAPS */
  ...
  <form id="form" class="ideal-form" action="javascript:saveForm('form','cliente/update.php')" >
  	<fieldset>
      <legend>E D I T A&nbsp;&nbsp;&nbsp;C L I E N T E</legend>
        ...
        <input id="codCli" name="codCli" type="hidden" value="<?=$file['id_cliente'];?>"/>
        </div><!--End idealWrap-->
        
       	<div class="idealWrap WrapD">
        <input id="nameEmp" name="nameEmp" type="text" placeholder="Nombre Negocio" value="<?=$file['nombreEmp'];?>" class="validate[required] text-input" autocomplete="off"  />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap Wrap">
        <input id="name" name="name" type="text" placeholder="Nombre" value="<?=$file['nombre'];?>" class="validate[required] text-input" autocomplete="off" onBlur="cargaCod()" />
        </div><!--End idealWrap-->
        
        <div class="idealWrap Wrap">
        <input id="paterno" name="paterno" type="text" placeholder="Ap. Paterno" value="<?=$file['apP'];?>" class="validate[required] text-input" onBlur="cargaCod()" />
        </div><!--End idealWrap-->
        ...
        <input id="ci" name="ci" type="text" placeholder="N° C.I." value="<?=$file['ci'];?>" class="validate[custom[integer1]] text-input" />        
        </div><!--End idealWrap-->
        ...
        <div class="idealWrap WrapD">
        <input id="addresC" name="addresC" type="text" placeholder="Direcci&oacute;n" value="<?=$file['direccion'];?>" class="validate[required] text-input" />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap WrapCR">
        <input id="cx" name="cx" type="text" placeholder="Zona" value="<?=$file['coorX'];?>" class="validate[required] text-input" readonly/>
        </div><!--End idealWrap-->
        
        <div class="idealWrap WrapCR">
        <input id="cy" name="cy" type="text" placeholder="Zona" value="<?=$file['coorY'];?>" class="validate[required] text-input" readonly/>
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        ...
        <div class="idealWrap">
        <textarea id="obser" name="obser" cols="2" placeholder="Observaciones" class="validate[required] text-input" ><?=$file['obser'];?></textarea>
        </div><!--End idealWrap-->

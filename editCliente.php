...
<script>
  ...
  <form id="form" class="ideal-form" action="javascript:saveForm('form','cliente/update.php')" >
      ...
      <legend>E D I T A&nbsp;&nbsp;&nbsp;C L I E N T E</legend>
        ...
        <input id="fecha" name="fecha" type="text" value="<?=$fecha;?> <?=$hora;?>" disabled />
        ...
        <input id="ci" name="ci" type="text" placeholder="N° C.I." value="<?=$file['id_cliente'];?>" disabled />
        <input id="ci" name="ci" type="hidden" value="<?=$file['id_cliente'];?>" />
        </div><!--End idealWrap-->
        ...
        <input id="cx" name="cx" type="text" placeholder="Zona" value="<?=$file['coorX'];?>" class="validate[required] text-input"/>
        </div><!--End idealWrap-->

        <div class="idealWrap WrapCR">
        <input id="cy" name="cy" type="text" placeholder="Zona" value="<?=$file['coorY'];?>" class="validate[required] text-input"/>
        </div><!--End idealWrap-->
        <div class="clearfix"></div>

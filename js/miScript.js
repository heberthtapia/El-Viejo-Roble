...
/* imagen a desplegar */
  ...
  if(data.img !== ''){
	  img = "<img class='thumb' src='thumb/phpThumb.php?src=../modulo/"+data.tabla+"/uploads/photos/"+data.img+"&amp;w=100&h=50&far=1&bg=FFFFFF&hash=361c2f150d825e79283a1dcc44502a76' alt=''>";
  }else{
	  img = "<img class='thumb' src='thumb/phpThumb.php?src=../modulo/"+data.tabla+"/uploads/photos/sin_imagen.jpg&amp;w=100&h=50&far=1&bg=FFFFFF&hash=361c2f150d825e79283a1dcc44502a76' alt=''>";
	  }
/***********************/
